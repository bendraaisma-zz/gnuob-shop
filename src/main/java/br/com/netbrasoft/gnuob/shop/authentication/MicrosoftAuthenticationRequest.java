...
public class MicrosoftAuthenticationRequest extends AuthorizationRequest {
  ...
  public MicrosoftAuthenticationRequest(final URI uri, final ResponseType rt, final ResponseMode rm,
  ...
  public MicrosoftAuthenticationRequest(final URI uri, final ResponseType rt, final Scope scope,
      final ClientID clientID, final URI redirectURI, final State state) {
