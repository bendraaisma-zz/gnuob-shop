...
public class SpecificationMainMenuPanel extends Panel {
  ...
  protected void onInitialize() {
    final HomeTab homeTab = new HomeTab(Model.of(SpecificationMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.HOME_MESSAGE_KEY)));
    final CartTab cartTab = new CartTab(Model.of(SpecificationMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.CART_MESSAGE_KEY)));
    final SpecificationTab specificationTab = new SpecificationTab(Model.of(SpecificationMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.SPECIFICATION_MESSAGE_KEY)));
    final ConfirmationTab confirmationTab = new ConfirmationTab(Model.of(SpecificationMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.CONFIRMATION_MESSAGE_KEY)));
