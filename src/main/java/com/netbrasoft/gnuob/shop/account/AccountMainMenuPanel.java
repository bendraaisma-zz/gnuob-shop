...
public class AccountMainMenuPanel extends Panel {
   ...
   private final ITab wishListTab = new WishListTab(Model.of(getString("wishListMessage", new Model<String>(), "OFFER").toUpperCase()));
   ...
   protected void onInitialize() {
      ...
      mainMenuTabbedPanel.setSelectedTab(mainMenuTabbedPanel.getTabs().indexOf(accountTab));
