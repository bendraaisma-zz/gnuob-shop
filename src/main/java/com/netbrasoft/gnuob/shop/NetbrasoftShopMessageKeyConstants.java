...
/**
 * Central location where the custom message keys for internationalization are managed for all text
 * labels.
 *
 * @author "Bernard Arjan Draaisma"
 * @version 1.0
 */
public final class NetbrasoftShopMessageKeyConstants {
  ...
  private NetbrasoftShopMessageKeyConstants() {
