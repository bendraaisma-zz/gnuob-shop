...
public class CheckoutMainMenuPanel extends Panel {
  ...
  protected void onInitialize() {
    final HomeTab homeTab = new HomeTab(Model.of(CheckoutMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.HOME_MESSAGE_KEY)));
    final AccountTab accountTab = new AccountTab(Model.of(CheckoutMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.ACCOUNT_MESSAGE_KEY)));
    final WishListTab wishListTab = new WishListTab(Model.of(CheckoutMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.WISH_LIST_MESSAGE_KEY)));
    final CheckoutTab checkoutTab = new CheckoutTab(Model.of(CheckoutMainMenuPanel.this.getString(NetbrasoftShopMessageKeyConstants.CHECKOUT_MESSAGE_KEY)));
