...
public final class Utils {
   ...
   public static Archive<?> createDeployment() {
      ...
      return ShrinkWrap.create(WebArchive.class, "gnuob-test-application.war").addPackages(true, "com.netbrasoft.gnuob.shop").addPackages(true, "com.netbrasoft.gnuob.api").addAsResource("META-INF/MANIFEST.MF", "META-INF/MANIFEST.MF")
            .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml").addAsLibraries(wicketCore, wicketExtentsion, oauth2OidcSdk, wicketStuff, wicketBootstrap);
   }
}
